...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("Registration successful! Redirecting you...");
      ...
      // Store the entire user object in context using setUser
      const user = {
        id,
        username,
        email,
      ...
      // Optionally, you could redirect the user after registration
      setTimeout(() => window.location.replace("/"), 2000); // Redirect to home page after a slight delay
    } catch (error) {
      console.error(
        "Error creating user:",
