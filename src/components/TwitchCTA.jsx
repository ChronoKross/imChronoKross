...
const TwitchCTA = () => {
  return (
    <div className="mt-8 flex flex-col items-center justify-center bg-gray-800 text-white rounded-lg shadow-lg max-w-md mx-auto transition-transform duration-300 ease-in-out hover:shadow-2xl hover:border-4 hover:border-purple-500 hover:animate-shake">
      <img
